const preload = () => {
  ...
  class Environment {
	...
	detectDarkMode() {
	  ...
	  this.setBackground(isDarkMode ? '#000000' : '#ffffff');
	  this.setForeground(isDarkMode ? '#ffffff' : '#000000');
	}
  ...
  class CreateParticles {
	...
	constructor(scene, font, particleImg, camera, renderer) {
	  ...
	  this.data = {
		text: 'xo.rs',
		amount: 1500,
		particleSize: 1.2, // Increase particle size
		particleColor: 0xffffff,
		textSize: 16,
		area: 250,
		ease: .03, // Slower return to unaltered form
	  }
